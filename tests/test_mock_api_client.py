...
@respx.mock
async def test_mock_api_client_sends_bearer_token_and_unwraps_data_response():
    ...
    client = MockApiClient("http://mock.local/", "mock-api-key-12345")
...
@respx.mock
async def test_mock_api_client_maps_transient_http_status_to_retryable_error():
...
@respx.mock
async def test_mock_api_client_maps_non_retryable_http_status_to_permanent_error():
